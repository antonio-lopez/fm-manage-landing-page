  ...
  return (
    <section>
      <div className='max-w-6xl px-5 mx-auto mt-32 text-center overflow-hidden'>
        ...
        >
          <div className=' flex flex-col mt-24 h-48  md:flex-row  sm:h-64 xl:h-80 2xl:h-96'>
            {/* testimonial 1 */}
            <div
            ...
            <div
              ...
              className='flex flex-col items-center p-6 space-x-6 rounded-lg bg-veryLightGray duration-700 ease-in-out absolute inset-0 transition-all transform translate-x-full z-10 md:w-1/2'
            >
              <img src={avatarAli} className='w-16 -mt-14' alt='avatar Ali' />
          ...
          <div className='flex absolute bottom-5 left-1/2 z-30 space-x-3 -translate-x-1/2'>
            <button
              type='button'
              className='w-3 h-3 rounded-full border-2 border-brightRed bg-brightRed hover:bg-brightRed'
              aria-current='false'
              aria-label='Slide 1'
